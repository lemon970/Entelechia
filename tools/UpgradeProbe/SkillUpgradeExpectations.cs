...
internal static class SkillUpgradeExpectations
{
    ...
    [
        UpgradeTestHarness.Case<Autophagy>(CardType.Skill, Property("HpCost", 3m, 2m)),
        UpgradeTestHarness.Case<BloodBorrow>(CardType.Skill, Cards(3m, 4m)),
        ...
        UpgradeTestHarness.Case<BloodHaste>(CardType.Skill, Power<BloodSpeedPower>(1m, 2m), Property("HpCost", 2m, 2m)),
        UpgradeTestHarness.Case<BloodInfect>(CardType.Skill, Power<BloodlossPower>(4m, 6m), Cards(1m, 1m)),
        UpgradeTestHarness.Case<EntelechiaBloodletting>(CardType.Skill, Power<BloodSpeedPower>(1m, 1m), Power<BloodlettingStrengthPower>(2m, 3m), Property("HpCost", 4m, 4m)),
        ...
        UpgradeTestHarness.Case<BloodOffering>(CardType.Skill, Cards(2m, 3m), Property("HpCost", 3m, 3m)),
        UpgradeTestHarness.Case<BloodOverload>(CardType.Skill, Power<BloodSpeedPower>(2m, 3m), Property("HpCost", 2m, 2m)),
        UpgradeTestHarness.Case<BloodPulse>(CardType.Skill, Cards(2m, 3m)),
        ...
        UpgradeTestHarness.Case<BloodVeil>(CardType.Skill, Block(6m, 9m)),
        ...
        UpgradeTestHarness.Case<CrimsonSacrifice>(CardType.Skill, Cards(4m, 5m), Property("HpCost", 6m, 6m)),
        UpgradeTestHarness.Case<CrimsonShield>(CardType.Skill, Block(10m, 13m), Power<BloodlossPower>(1m, 1m)),
        UpgradeTestHarness.Case<DiscontinuousPulse>(CardType.Skill, Cards(1m, 1m), Power<BloodlossPower>(2m, 3m)),
        UpgradeTestHarness.Case<HeartBrand>(CardType.Skill, Power<HeartCandlePower>(12m, 18m), Cards(1m, 1m), Property("ExistingCandlePercent", 6m, 9m)),
        ...
        UpgradeTestHarness.Case<ReviveCandle>(CardType.Skill, Property("ReviveRatio", 0.50m, 1.00m)),
